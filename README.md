...
Many people are aware that bank accounts in the US are insured by the [FDIC](https://en.wikipedia.org/wiki/Federal_Deposit_Insurance_Corporation) up to $250K per account. Client assets at US brokerage firms are also insured, but there are many regulations intended to protect client assets before insurance is ever needed:
...
This section is simply meant to warn you about a price drop you may (or may not!) observe in some of your funds at the end of each year. You can always check the ex-dividend date and payment date ahead of time. Schwab has the best interface for viewing this information, because they make it very easy to see the dates and composition of different distributions. Just type the ticker symbol in their website's search bar and click the "Distributions & Yields" section. (You need a Schwab account to use this feature, though it need not be funded.) You can also check distributions from previous years, because a fund's schedule of distributions tends to be very uniform over time.
...
The writing up to this point may have given the impression that, if one wants to avoid transaction fees, Vanguard mutual funds are available only through a Vanguard account, Fidelity mutual funds are available only through a Fidelity account, and so on. Even companies that are both asset managers and brokers — like Vanguard, Fidelity, and Schwab — tend to offer no-fee access to some mutual funds other than their own. With an E\*Trade account, for instance, you can trade shares of [VTWAX](https://investor.vanguard.com/investment-products/mutual-funds/profile/vtwax), [VTSAX](https://investor.vanguard.com/investment-products/mutual-funds/profile/vtsax), and [VTIAX](https://investor.vanguard.com/investment-products/mutual-funds/profile/vtiax) with no transaction fees. However, before buying any mutual fund you should ensure that there are no extra conditions, like a [short-term redemption fee](https://www.investopedia.com/terms/r/redemptionfee.asp), due to buying in a different brokerage account. Yet another advantage of ETFs is that you don't have to worry about potentially surprising fees. For example, Vanguard's fixed income mutual funds [VGAVX](https://investor.vanguard.com/investment-products/mutual-funds/profile/vgavx) and [VBLAX](https://investor.vanguard.com/investment-products/mutual-funds/profile/vblax) have purchase fees to disincentivize rapid trading — even if you trade in a Vanguard account — but their ETF counterparts [VWOB](https://investor.vanguard.com/investment-products/etfs/profile/vwob) and [BLV](https://investor.vanguard.com/investment-products/etfs/profile/blv) have no such fees.
