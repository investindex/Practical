...
An example of rebalancing from dividends will be useful. Let's say we have a portfolio of two stock funds (35% each) which distribute quarterly dividends and a bond fund (30%) which distributes monthly dividends. We invest at the beginning of June, and the share prices of the bond fund and one stock fund rise throughout the month, while the other stock fund's share price falls slightly. We then receive dividends from all three funds and decide to reinvest them. The portions of each fund have shifted from 35%/35%/30% to 39%/34%/27%. Bond funds becoming underweighted is common because stock funds grow more quickly in [bull markets](https://www.investopedia.com/terms/b/bullmarket.asp). So instead of simply reinvesting each fund's dividends, we invest most of the new cash in the bond fund to move its allocation closer to the intended 30%, and a smaller portion in the stock fund which has fallen to 34%. We reinvest none in the stock fund which grew to 39%. After reinvestment we've shifted our allocation from 39%/34%/27% to 36%/35%/29%, which is very close to our intended allocation. Of course, be aware that if you do not reinvest all of a fund's dividends in that fund, you will not receive its [total return](https://www.investopedia.com/terms/t/totalreturn.asp).

You can use the same approach when investing your income. 
